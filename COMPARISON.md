# How DataCollections compares

Continues the argument [README.md](./README.md) sets up. Read the strictness
spectrum and the comparison table there first — this document is the reasoning
behind that table, approach by approach, and what it leaves missing.
...
- An **Icechunk Zarr DataTree fails on exactly two: scalable index and
  schema-constrained.** Which is the table restating the equation —
